...
class Payments(BaseClass):
    ...
    course = models.ForeignKey('course.Courses',on_delete=models.CASCADE)
...
class Transactions(BaseClass):
    ...
    def __str__(self):
        ...
        return f'{self.payment.student.name}-{self.payment.course.title}-Transaction'
